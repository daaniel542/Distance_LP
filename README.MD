...
Your input file should have at least 2 columns, Origin and Dsestination. However using providing Origin and Destination LOCODEs will greatly improve accuracy:
